Ingot Titanium SDK Plugin
=========================

This is an Ingot automation platform plugin that handles Titanium SDK related
automation tasks.

## Reporting Bugs or submitting fixes

If you run into problems, and trust us, there are likely plenty of them at this
point -- please create an [Issue](https://github.com/appcelerator/ingot-titanium-sdk/issues)
